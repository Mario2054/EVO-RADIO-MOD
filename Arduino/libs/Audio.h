...
public:
    // --- Dodane do obsługi 16-pasmowego equalizera ---
    void setGraphicEQ16(const int8_t* gains);
    void enableGraphicEQ16(bool enabled);
    bool isGraphicEQ16Enabled() const { return m_graphicEQ16Enabled; }
    void getGraphicEQ16(int8_t* out16) const;
...
private:
    // --- Dodane do obsługi 16-pasmowego equalizera ---
    int8_t m_graphicEQ16Gains[16] = {0};
    bool m_graphicEQ16Enabled = false;
    // ------- PRIVATE MEMBERS ----------------------------------------
